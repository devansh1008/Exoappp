...
const Navbar = () => {
  return (
    <div className="w-full fixed z-[999]">
      <div className=" max-w-screen-xl flex items-center justify-between text-white sm:py-10 sm:px-10 h-20 mx-auto px-5 py-5">
        <motion.div
          initial={{ opacity: 0 }}
        ...
        <motion.div
          ...
          className="links hidden sm:flex flex gap-10">
          <NavLink
            style={(e) => {
              return {
